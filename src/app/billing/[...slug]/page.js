    ...
    return (
        <div
            ...
            <div className="absolute inset-0 overflow-hidden">
                ...
                <div
                    className="absolute top-1/4 left-1/4 w-72 md:w-96 h-72 md:h-96 bg-gradient-to-br from-pink-400/15 to-purple-400/15 rounded-full blur-3xl animate-pulse"></div>
                <div
                    className="absolute bottom-1/4 right-1/4 w-64 md:w-80 h-64 md:h-80 bg-gradient-to-br from-purple-400/15 to-pink-400/15 rounded-full blur-3xl animate-pulse delay-1000"></div>
            </div>
            ...
            <div className="relative z-10 px-4 sm:px-6 pb-12">
                ...
                >
                    ...
                    <div className="text-center mb-10 sm:mb-12">
                        <div
                            className="inline-flex items-center px-3 py-1.5 sm:px-4 sm:py-2 mb-4 sm:mb-6 bg-white/10 backdrop-blur-lg border border-white/20 rounded-full">
                ...
                Booking
                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 md:gap-8">
                        ...
                        <div className="xl:col-span-1">
                            <div
                                className="bg-white/5 backdrop-blur-xl rounded-3xl border border-white/10 shadow-2xl overflow-hidden xl:sticky xl:top-8">
                                {/* Service Header */}
                                <div className="p-6 sm:p-8 text-center border-b border-white/10">
                                    ...
                                    {sharedData.duration && (
                                        <div
                                            className="flex items-center justify-center space-x-2 text-white/60 text-xs sm:text-sm mb-3 sm:mb-4">
                    ...
                    <span
                        className="text-3xl sm:text-4xl font-black bg-gradient-to-r from-pink-300 to-purple-300 bg-clip-text text-transparent drop-shadow-lg">
                      ${sharedData.price ?? 0}
                    </span>
                                    ...
                                    <div className="space-y-2 sm:space-y-3 mb-5 sm:mb-6">
                                        {sharedData.features?.map((feature, idx) => (
                                            <div key={idx} className="flex items-start space-x-2 sm:space-x-3">
                                                <Check
                                                    className="w-3 sm:w-4 h-3 sm:h-4 text-green-400 flex-shrink-0 mt-0.5"/>
                          ...
                          {feature}
                                    ...
                                    <div className="space-y-2 sm:space-y-3">
                                        {benefits.map((benefit, idx) => (
                                            <div key={idx} className="flex items-start space-x-2 sm:space-x-3">
                                                <benefit.icon
                                                    className="w-3 sm:w-4 h-3 sm:h-4 text-pink-400 flex-shrink-0 mt-0.5"/>
                                                <span className="text-white/80 text-xs sm:text-sm">
                          {benefit.text}
                        </span>
                                            </div>
                        ...
                        <div className="xl:col-span-2 space-y-6 md:space-y-8">
                            ...
                            <div
                                ...
                                <div className="p-6 sm:p-8">
                                    <div className="flex items-center space-x-3 mb-5 sm:mb-6">
                                        <div
                                            className="w-9 h-9 sm:w-10 sm:h-10 bg-gradient-to-br from-green-400 to-emerald-500 rounded-xl flex items-center justify-center">
                                    ...
                                    {/* Security Indicators */}
                                    <div
                                        className="flex flex-wrap gap-3 sm:gap-6 mb-6 sm:mb-8 p-3 sm:p-4 bg-white/5 rounded-xl border border-white/10">
                                        <div
                                            className="flex items-center space-x-1 sm:space-x-2 text-green-400 text-xs sm:text-sm">
                                            <Lock className="w-3 sm:w-4 h-3 sm:h-4"/>
                                            <span>SSL Encrypted</span>
                                        </div>
                                        <div
                                            className="flex items-center space-x-1 sm:space-x-2 text-blue-400 text-xs sm:text-sm">
                                            <Shield className="w-3 sm:w-4 h-3 sm:h-4"/>
                                            <span>Stripe Secure</span>
                                        </div>
                                        <div
                                            className="flex items-center space-x-1 sm:space-x-2 text-purple-400 text-xs sm:text-sm">
                                    ...
                                    {/* Stripe Checkout */}
                                    <div
                                        className="bg-gradient-to-br from-purple-500/10 to-pink-500/10 rounded-2xl border border-pink-300/20 p-4 sm:p-6">
                                        <Elements
                                        ...
                                        >
                                            <paymentContext.Provider value={sharedData}>
                                                <CheckOut/>
                            ...
                            {/* Testimonials */}
                            <div
                                className="bg-white/5 backdrop-blur-xl rounded-3xl border border-white/10 shadow-2xl p-6 sm:p-8">
                                <div className="flex items-center space-x-3 mb-5 sm:mb-6">
                                    <div
                                        className="w-9 h-9 sm:w-10 sm:h-10 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-xl flex items-center justify-center">
                                    ...
                                    {testimonials.map((testimonial, idx) => (
                                        ...
                                        >
                                            ...
                                            <div className="flex items-center space-x-2 sm:space-x-3">
                                                <div
                                                    className="w-7 h-7 sm:w-8 sm:h-8 bg-gradient-to-br from-pink-400 to-purple-500 rounded-full flex items-center justify-center">
