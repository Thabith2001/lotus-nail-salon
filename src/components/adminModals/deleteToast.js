...
let isDeleteToastActive = false;
 export const HandleDelete = (id) => {
    if (isDeleteToastActive) return;
    isDeleteToastActive = true;

    toast.custom((t) => (
        <div className="flex items-start gap-3 p-4 bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl shadow-lg text-white">
