...
import {
    Scissors, Sparkles, Crown, Heart, Palette, Clock, DollarSign, Calendar, Star,
} from "lucide-react";
...
const iconMap = {
    Scissors, Sparkles, Crown, Heart, Palette, Star,
};
...
const Services = () => {
    ...
    return (<section
            className="relative min-h-screen w-full py-20 bg-gradient-to-br from-slate-900 via-purple-900 to-pink-900 overflow-hidden">
            {/* Sparkles */}
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6">
                ...
                <div className="text-center  mb-16">
                    ...
                    <h2 className="text-5xl md:text-7xl lg:text-8xl font-black leading-tight mb-6">
                      <span
                    ...
                    <p className="text-xl text-white/70 max-w-3xl mx-auto leading-relaxed font-extralight">
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="flex items-start justify-between mb-4">
                                    <div
                                        className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${service.color || "from-pink-500 to-purple-500"} flex items-center justify-center shadow-lg`}
                                    >
                                ...
                                <div className="space-y-2 mb-4">
                                    {service.features?.map((feature, idx) => (<div
                                            key={idx}
                ...
                {/* CTA Section */}
                <div
                    className="bg-gradient-to-r from-pink-500/10 via-purple-500/10 to-pink-500/10 backdrop-blur-xl border-2 border-white/20 rounded-3xl p-12 text-center">
                ...
                SAVE WITH MEMBERSHIP
                        ...
                        <p className="text-lg text-white/70 mb-8 max-w-2xl mx-auto font-extralight leading-relaxed">
