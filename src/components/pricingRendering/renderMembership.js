    ...
    useEffect(() => {
        const fetchMemberships = async () => {
            try {
                ...
                const data = Array.isArray(res.data) ? res.data : res.data?.memberships || [];
                setMemberships(data);
            } catch (err) {
                        ...
                        >
                                ...
                                <div className="absolute top-6 right-6 z-10">
                                    <div className="relative">
                                        ...
                                        <div
                                            ...
                                            <span>Save ${membership.savings}/mo</span>
                                        </div>
                                    </div>
                                </div>
                            )}
                            ...
                            <div className="flex flex-col h-full p-6">
                                ...
                                <div className="text-center pt-8 pb-6">
                                    ...
                                    <p className="text-white/60 text-sm leading-relaxed h-10">
                                ...
                                <div className="text-center pb-6">
                                    ...
                                    <p className="text-white/50 text-sm font-medium mb-3">per month</p>
                                    {membership.sessions && (
                                        <div
                                            className="inline-flex items-center gap-2 px-3 py-1 bg-green-500/20 border border-green-500/30 rounded-full">
                                ...
                                {/* Features Section - Scrollable with fixed height */}
                                <div
                                    ...
                                    {Array.isArray(membership.benefits) && membership.benefits.length > 0 && (
                                        <div>
                                            <h4 className="text-white/90 font-bold text-xs uppercase tracking-wider mb-3 flex items-center gap-2">
                                                <div
                                                    className="w-1 h-4 bg-gradient-to-b from-yellow-400 to-orange-400 rounded-full"/>
                                                Exclusive Perks
                                            </h4>
                                            <div className="flex flex-col space-y-2.5">
                                                {membership.benefits.map((benefit, idx) => (
                                                    <div key={idx}
                                                         className="flex items-start space-x-3 group/item">
                                                        <div
                                                            className="flex-shrink-0 w-5 h-5 rounded-full bg-yellow-500/20 flex items-center justify-center mt-0.5 group-hover/item:bg-yellow-500/30 transition-colors">
                                                            <Star
