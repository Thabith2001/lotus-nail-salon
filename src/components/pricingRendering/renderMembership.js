            ...
            {memberships.map((membership, index) => {
                ...
                return (
                    <div
                        ...
                        className={`group relative bg-gradient-to-b from-white/5 to-white/[0.02] backdrop-blur-xl border rounded-3xl overflow-hidden transition-all duration-500 hover:shadow-2xl ${
                        ...
                        <div className="p-6 sm:p-8 pt-10 sm:pt-12">
                            ...
                            <div className="text-center mb-4 sm:mb-6">
                                <div className="relative inline-block mb-5">
                                    ...
                                    ></div>
                                    <div
                                        className={`relative mb-5 w-20 h-20 bg-gradient-to-br ${theme.gradient} rounded-2xl flex items-center justify-center shadow-xl transform group-hover:scale-110 group-hover:rotate-6 transition-all duration-500`}
                                    >
                                        <Crown className="w-15 h-15 text-white" />
                                    </div>
                                </div>

                                <h3 className="text-2xl sm:text-3xl font-bold text-white mb-2 sm:mb-3 group-hover:scale-105 transition-transform duration-300">
                                    {membership.name}
                                </h3>
                                <p className="text-white/60 text-sm leading-relaxed mb-4 sm:mb-6 px-2">
                                ...
                                <div className="relative inline-block mb-4 sm:mb-6">
                                    <div className="flex items-baseline justify-center gap-2 sm:gap-3">
                                        ...
                                        <div className="relative">
                                            ...
                                            ></div>
                                            <span
                                                className={`relative text-4xl sm:text-5xl font-black bg-gradient-to-r ${theme.accent} bg-clip-text text-transparent`}
                                            >
                                                ${membership.price}
                                            </span>
                                        </div>
                                    ...
                                    {membership.sessions && (
                                        <div className="mt-3 inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 bg-green-500/20 border border-green-500/30 rounded-full">
                            ...
                            {Array.isArray(membership.features) && membership.features.length > 0 && (
                                <div className="mb-6">
                                    <h4 className="text-white/90 font-bold text-sm uppercase tracking-wider mb-4 flex items-center gap-2">
                                        <div
                                    ...
                                    <div className="space-y-3">
                                        {membership.features.map((feature, idx) => (
                                            ...
                                            >
                                                <div className="flex-shrink-0 w-5 h-5 rounded-full bg-green-500/20 flex items-center justify-center mt-0.5 group-hover/item:bg-green-500/30 transition-colors">
                                                    <Check className="w-3 h-3 text-green-400" />
                                                </div>
                                                <span className="text-white/70 text-sm leading-relaxed group-hover/item:text-white/90 transition-colors">
                                                    {feature}
                                                </span>
                                            </div>
                                        ))}
                                    ...
                                    <div className="space-y-3">
                                        {membership.benefits.map((benefit, idx) => (
                                            <div
                                                ...
                                                className="flex items-start space-x-3 group/item"
                                            >
                                                <div className="flex-shrink-0 w-5 h-5 rounded-full bg-yellow-500/20 flex items-center justify-center mt-0.5 group-hover/item:bg-yellow-500/30 transition-colors">
