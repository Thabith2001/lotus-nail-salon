    ...
    if (loading) {
        return (
            <div className="fixed inset-0 bg-black/70 backdrop-blur-md z-50 flex items-center justify-center p-4">
                <div className="bg-gradient-to-br from-slate-900/95 via-purple-900/95 to-slate-900/95 backdrop-blur-xl rounded-2xl p-8 max-w-sm w-full border border-purple-500/30 shadow-2xl">
        ...
        >
            ...
            >
                {success ? (
                    ...
                    <>
                        {/* Header */}
                        <div className="p-6 border-b border-purple-500/20 bg-gradient-to-r from-purple-500/5 to-pink-500/5">
                        ...
                        <div className="p-6 space-y-5">
                            ...
                            {/* Time Selection */}
                            {rescheduleDate && (
                                <div className="bg-gradient-to-br from-green-500/10 to-emerald-500/10 rounded-xl p-5 border border-green-400/30">
                                    <div className="flex items-center gap-2 mb-3">
                                    ...
                                    {loadingBookings ? (
                                        <div className="flex flex-col items-center justify-center h-40 bg-white/5 rounded-lg">
                                            <div className="w-8 h-8 border-3 border-green-500/20 border-t-green-500 rounded-full animate-spin mb-2"></div>
                                                ...
                                                return (
                                                    <button
                                                        ...
                                                        className={`p-3 rounded-lg text-center transition-all ${
                                                            isSelected
                                                                ? "bg-gradient-to-br from-green-500 to-emerald-600 shadow-lg scale-105"
                                                                : isDisabled
                                                    ...
                                                    >
                                                        ...
                                                        <div className="flex items-center justify-center gap-1 mt-1">
                                                            {isBooked ? (
                                                                <span className="text-red-300 text-xs">Booked</span>
                                                            ) : isPast ? (
                            ...
                            {rescheduleDate && rescheduleTime && (
                                <div className="bg-gradient-to-br from-blue-500/10 to-cyan-500/10 rounded-xl p-5 border border-blue-400/30">
                                    <div className="flex items-center gap-2 mb-3">
                            ...
                            {/* Error Message */}
                            {error && (
                                <div className="p-4 bg-red-500/10 border border-red-400/40 rounded-xl flex items-start gap-3">
